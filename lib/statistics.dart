...
Map<String, dynamic> _getMonthlyStats(UnifiedStatsData stats, DateTime month) {
  ...
  int totalProblems = monthRecords.fold<int>(0, (int sum, record) => sum + record.attempted);
  int totalCorrect = monthRecords.fold<int>(0, (int sum, record) => sum + record.correct);
  
  return {
    'count': monthRecords.length,
    'problems': totalProblems,
    'accuracy': (totalCorrect / totalProblems) * 100,
  };
}
