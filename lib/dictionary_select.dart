...
class _DictionarySelectPageState extends State<DictionarySelectPage>
  ...
  // 검색 카드 수정: 고정 높이 제거 및 유연한 구조로 변경
  Widget _buildSearchCard(bool isDarkMode) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (_) => DictionarySearchPage()));
      },
      child: Container(
        // 에러 해결 포인트 1: height: 100 제거 후 minHeight 사용
  ...
  Widget _buildMainFeatures(bool isDarkMode) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(height: 16),
      Row(
        crossAxisAlignment: CrossAxisAlignment.start, // 카드 높이가 다를 수 있으므로 정렬
        children: [
          Expanded(
            child: _buildFeatureCard(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => DictionaryCardPage(category: null)));
              },
            ),
          ),
          SizedBox(width: 12),
            ...
            child: _buildFeatureCard(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => DictionaryBookmarkPage()));
              },
            ),
          ),
        ],
  ...
  Widget _buildFeatureCard({
    ...
    return GestureDetector(
      onTap: onTap,
      child: Container(
        // 에러 해결 포인트 3: height: 120 제거 후 minHeight 사용
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // 에러 해결 포인트 4: Spacer() 제거 (가변 높이에서는 Spacer 사용 지양)
                    SizedBox(height: 16),
                    Text(
                      title,
                      style: TextStyle(
